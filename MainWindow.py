...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1094, 703)
        MainWindow.setMinimumSize(QtCore.QSize(800, 0))
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setEnabled(True)
        self.tabWidget.setGeometry(QtCore.QRect(10, 10, 1041, 631))
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(200, 10, 791, 361))
        ...
        self.layoutWidget5 = QtWidgets.QWidget(self.tab_filters)
        self.layoutWidget5.setGeometry(QtCore.QRect(10, 140, 171, 131))
        ...
        self.pushButton_filters_load = QtWidgets.QPushButton(self.layoutWidget5)
        ...
        self.layoutWidget6 = QtWidgets.QWidget(self.tab_histograms)
        self.layoutWidget6.setGeometry(QtCore.QRect(280, 10, 701, 531))
        self.layoutWidget6.setObjectName("layoutWidget6")
        self.gridLayout = QtWidgets.QGridLayout(self.layoutWidget6)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.label_histograms_input = QtWidgets.QLabel(self.layoutWidget6)
        ...
        self.label_histograms_output = QtWidgets.QLabel(self.layoutWidget6)
        ...
        self.label_histograms_hinput = QtWidgets.QLabel(self.layoutWidget6)
        ...
        self.label_histograms_houtput = QtWidgets.QLabel(self.layoutWidget6)
        ...
        self.layoutWidget7 = QtWidgets.QWidget(self.tab_histograms)
        self.layoutWidget7.setGeometry(QtCore.QRect(40, 200, 201, 131))
        self.layoutWidget7.setObjectName("layoutWidget7")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.layoutWidget7)
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.pushButton_Auto_global_thershold = QtWidgets.QPushButton(self.layoutWidget7)
        ...
        self.pushButton_globalThershold = QtWidgets.QPushButton(self.layoutWidget7)
        ...
        self.doubleSpinBox_Thershold_value = QtWidgets.QDoubleSpinBox(self.layoutWidget7)
        ...
        self.layoutWidget8 = QtWidgets.QWidget(self.tab_histograms)
        self.layoutWidget8.setGeometry(QtCore.QRect(40, 350, 201, 131))
        self.layoutWidget8.setObjectName("layoutWidget8")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.layoutWidget8)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.pushButton_local_thershold = QtWidgets.QPushButton(self.layoutWidget8)
        ...
        self.spinBox_thershlod_filter_size = QtWidgets.QSpinBox(self.layoutWidget8)
        ...
        self.comboBox_thersholding_filter = QtWidgets.QComboBox(self.layoutWidget8)
        ...
        self.layoutWidget9 = QtWidgets.QWidget(self.tab_histograms)
        self.layoutWidget9.setGeometry(QtCore.QRect(40, 20, 201, 171))
        self.layoutWidget9.setObjectName("layoutWidget9")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.layoutWidget9)
        self.gridLayout_4.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.pushButton_histograms_load = QtWidgets.QPushButton(self.layoutWidget9)
        ...
        self.layoutWidget10 = QtWidgets.QWidget(self.tab_hybrid)
        self.layoutWidget10.setGeometry(QtCore.QRect(180, 20, 811, 521))
        self.layoutWidget10.setObjectName("layoutWidget10")
        self.gridLayout_7 = QtWidgets.QGridLayout(self.layoutWidget10)
        self.gridLayout_7.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.label_histograms_input_2 = QtWidgets.QLabel(self.layoutWidget10)
        ...
        self.label_histograms_output_2 = QtWidgets.QLabel(self.layoutWidget10)
        ...
        self.label_histograms_hinput_2 = QtWidgets.QLabel(self.layoutWidget10)
        ...
        self.layoutWidget11 = QtWidgets.QWidget(self.tab_hybrid)
        self.layoutWidget11.setGeometry(QtCore.QRect(20, 20, 131, 121))
        self.layoutWidget11.setObjectName("layoutWidget11")
        self.gridLayout_8 = QtWidgets.QGridLayout(self.layoutWidget11)
        self.gridLayout_8.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_8.setObjectName("gridLayout_8")
        self.pushButton_histograms_load_2 = QtWidgets.QPushButton(self.layoutWidget11)
        ...
        self.layoutWidget12 = QtWidgets.QWidget(self.tab_hybrid)
        self.layoutWidget12.setGeometry(QtCore.QRect(20, 170, 131, 131))
        self.layoutWidget12.setObjectName("layoutWidget12")
        self.gridLayout_9 = QtWidgets.QGridLayout(self.layoutWidget12)
        self.gridLayout_9.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_9.setObjectName("gridLayout_9")
        self.pushButton_histograms_load_3 = QtWidgets.QPushButton(self.layoutWidget12)
        ...
        self.label_14 = QtWidgets.QLabel(self.layoutWidget12)
        self.label_14.setObjectName("label_14")
        self.gridLayout_9.addWidget(self.label_14, 2, 0, 1, 1)
        self.layoutWidget13 = QtWidgets.QWidget(self.tab_hybrid)
        self.layoutWidget13.setGeometry(QtCore.QRect(20, 310, 131, 81))
        self.layoutWidget13.setObjectName("layoutWidget13")
        self.gridLayout_10 = QtWidgets.QGridLayout(self.layoutWidget13)
        self.gridLayout_10.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_10.setObjectName("gridLayout_10")
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.label_8 = QtWidgets.QLabel(self.layoutWidget13)
        self.label_8.setObjectName("label_8")
        self.horizontalLayout_6.addWidget(self.label_8)
        self.doubleSpinBox_alpha = QtWidgets.QDoubleSpinBox(self.layoutWidget13)
        ...
        self.pushButton_histograms_load_4 = QtWidgets.QPushButton(self.layoutWidget13)
        ...
        self.widget.setGeometry(QtCore.QRect(20, 420, 131, 91))
        self.widget.setObjectName("widget")
        self.gridLayout_11 = QtWidgets.QGridLayout(self.widget)
        self.gridLayout_11.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_11.setObjectName("gridLayout_11")
        self.comboBox_hybrid = QtWidgets.QComboBox(self.widget)
        self.comboBox_hybrid.setEnabled(False)
        ...
        self.comboBox_hybrid.addItem("")
        self.comboBox_hybrid.addItem("")
        self.gridLayout_11.addWidget(self.comboBox_hybrid, 2, 0, 1, 1)
